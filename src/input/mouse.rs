...
fn mouse_button_callback(button: MouseButton, action: Action) {
    ...
    match action {
        Action::Press => {
            match button {
                MouseButton::Button1 => {
                    mouse.buttons[0] = MouseButtonState::Pressed;
                }
                MouseButton::Button2 => {
                    mouse.buttons[1] = MouseButtonState::Pressed;
                }
                MouseButton::Button3 => {
                    mouse.buttons[2] = MouseButtonState::Pressed;
                }
                _ => {}
            }
        }
        Action::Release => {
            match button {
                MouseButton::Button1 => {
                    mouse.buttons[0] = MouseButtonState::Released;
                }
                MouseButton::Button2 => {
                    mouse.buttons[1] = MouseButtonState::Released;
                }
                MouseButton::Button3 => {
                    mouse.buttons[2] = MouseButtonState::Released;
                }
                _ => {}
            }
        }
